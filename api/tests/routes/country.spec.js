...
describe('Country routes (testing de las rutas GET)', () => {
	...
	describe('GET /countries?name (este es para el searh)', () => {
	...
	describe('GET /countries:id (traemos por id para el modal)', () => {
		...
		it('este retorna 404 ', () =>
			agent.get('/countries/AAA').expect(404).expect('id no valido'));
		it('este retorna 404 ', () =>
			agent.get('/countries/AA').expect(404).expect('id no valido'));
	});
...
describe('pruebas de la ruta POST ', () => {
