		...
		<StyledAbout>
			<div className='about'>
				...
				<p>
					...
					. In order to map all the different continents, this app consumes data
					from{' '}
					<a
					...
					. It is also possible to create a new activity.
				</p>
				<p>
					Any feedback you can provide will be greatly appreciated. Thank you,
					and don't forget to create your own Activity!
				</p>
			</div>
